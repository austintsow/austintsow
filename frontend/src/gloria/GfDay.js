 ...
 *
 * Restored verbatim from git 11ad70e (2025-08-01). This page used to be
 * Gloria.js itself and was overwritten when that became the passcode gate, so
 * it only existed in history. Wrapped in .gfday-page because its stylesheet
