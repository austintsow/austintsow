            ...
            <div className="about-content">
                <div className="about-wrapper">
                    ...
                    <div className="about-text">
                        ...
                        <p>
                            i'm from sammamish, washington, just outside seattle, and grew up in a taiwanese-american household. i'm currently finishing my computer science degree at gonzaga university with a concentration in software security, graduating in december 2025. my journey into software engineering has taken me from building ai-driven applications and cloud infrastructure at PACCAR to co-founding applyied and leading agile teams while shipping cross-platform mobile apps at IPCRX. recently, i've been deep in blockchain research, exploring how to build zero-fee payment systems that bridge web3 and traditional finance. what drives me isn't just the technology itself, but the potential to create systems that genuinely improve how people interact with software, whether that's automating tedious workflows, making job searches smarter, or reimagining financial infrastructure. i'm always chasing that next challenge, the kind that pushes me to learn something new and build something meaningful.

                        </p>
                        
                        <h3 className="section-title">hobbies</h3>
                        <p>
                            when i'm not coding, you'll find me outside living an active life. i spend weekends hiking in the pacific northwest, exploring trails across washington, always chasing new views and elevation gains. running has become a constant, whether training for a race or just clearing my mind on a long stretch of road. but my newest obsession is pickleball! i'm rated a 5.1 DUPR... in my dreams, at least. there's something addictive about the perfect third shot drop or a well-executed kitchen rally, and who knows, if i keep improving, maybe i'll actually earn that 5.1 one day. beyond the physical, i'm deeply fascinated by DeFi and the future of decentralized finance. i genuinely believe we're witnessing the infrastructure layer for the next generation of financial systems being built in real time. solana has become my favorite blockchain to follow and build on, the speed and low transaction costs make it feel like what crypto was always supposed to be. watching DeFi protocols evolve, experimenting with smart contracts, and staying plugged into the crypto community has become a legitimate hobby that blends my technical interests with my belief in what's possible.
                        </p>
