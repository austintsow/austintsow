            ...
            <div className="about-content">
                <div className="about-wrapper">
                    ...
                    <div className="about-text">
                        ...
                        <p>
                            i'm from sammamish, washington, just outside seattle, and grew up in a taiwanese-american household. i graduated from gonzaga university in december 2025 with a computer science degree and a concentration in software security and have recently joined visa's risk and identity solutions team! my journey into software engineering has taken me from building ai-driven applications and cloud infrastructure at PACCAR to co-founding applyied and leading agile teams while shipping cross-platform mobile apps at Independent Pharmacy Cooperative (IPC). what drives me isn't just the technology itself, but the potential to create systems that genuinely improve how people interact with software, whether that's automating tedious workflows, making job searches smarter, or building infrastructure that solves real problems. i'm always chasing that next challenge, the kind that pushes me to learn something new and build something meaningful.

                        </p>
                        
                        <h3 className="section-title">hobbies</h3>
                        <p>
                            when i'm not coding, you'll find me outside living an active life. i spend weekends hiking in the pacific northwest, exploring trails across washington, always chasing new views and elevation gains. running has become a constant, as i am now training for seattle's half marathon at the end of the year. but my newest obsession is pickleball! i'm rated a 8.0 DUPR... in my dreams, at least. there's something addictive about the perfect third shot drop or a well-executed kitchen rally, and who knows, if i keep improving, maybe i'll actually earn that 8.0 one day. beyond the physical, i'm deeply fascinated by DeFi and decentralized finance. i genuinely believe we're witnessing the infrastructure layer for the next generation of financial systems being built in real time. solana has become my favorite blockchain to build on because the speed and low transaction costs make it feel like what crypto was always supposed to be. experimenting with smart contracts, exploring zero-fee payment systems, and staying plugged into the crypto community has become a legitimate hobby that blends my technical interests with my belief in what's possible.
                        </p>
